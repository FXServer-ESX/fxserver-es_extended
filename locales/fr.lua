Locales['fr'] = {
  ...
  ['gave_weapon_ammo'] = 'vous avez donné ~o~%sx~s~ balles pour ~b~%s~s~ à ~y~%s~s~',
  ...
  ['received_weapon_ammo'] = 'vous avez reçu ~o~%sx~s~ balles pour votre ~b~%s~s~ de ~b~%s~s~',
  ...
  -- Key mapping
  ['keymap_showinventory'] = 'voir l\'inventaire',
