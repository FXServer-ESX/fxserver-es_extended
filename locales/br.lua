Locales['br'] = {
  ...
  ['noammo'] = 'voce não tem todas essas muniçoes!',
  ...
  ['gave_weapon_ammo'] = 'você deu ~o~%sx~s~ balas para ~b~%s~s~ de ~y~%s~s~',
  ...
  ['received_weapon_ammo'] = 'você recebeu ~o~%sx~s~ balas para a sua(o seu) ~b~%s~s~ de ~b~%s~s~',
