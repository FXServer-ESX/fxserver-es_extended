Locales['de'] = {
  ...
  ['threw_weapon_ammo'] = 'du wirfst ~b~%s~s~ mit ~o~%sx %s~s~ Kugeln weg',
  ...
  ['ammo_grenadelauncher'] = 'grenade(n)',
  ['ammo_grenade'] = 'grenade(n)',
  ['ammo_stickybomb'] = 'bomb(n)',
  ['ammo_pipebomb'] = 'bomb(n)',
  ['ammo_smokebomb'] = 'bomb(n)',
