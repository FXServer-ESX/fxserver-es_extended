...
ESX.KeysTable = function(key)
	...
	if key ~= nil and Keys[tostring(key)] then
		return Keys[tostring(key)]
	elseif key == nil then
		return Keys
	else
		print('Incorrect Usage of Function please use ESX.KeysTable("F3") to request a number or ESX.KeysTable() to request a table of all keys')
	end
end
