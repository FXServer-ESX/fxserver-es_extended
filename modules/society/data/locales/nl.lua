...
Translations = {
  ...
  ['deposit_society_money']  = 'stort maatschapbedrijfsgeld geld',
  ...
  ['fire']                   = 'ontslaan',
  ['grade']                  = 'rang',
  ['have_deposited']         = 'je hebt ~r~$%s~s~ op de rekening gestort',
  ['have_withdrawn']         = 'je hebt ~g~$%s~s~ van de rekening gehaald',
  ...
  ['withdraw_amount']        = 'aantal af te halen',
  ['withdraw_society_money'] = 'neem bedrijfs geld af',
  ['yes']                    = 'ja',
  ...
  ['you_have_been_fired']    = 'je bent ontslagen door %s',
